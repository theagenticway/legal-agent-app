...
export type ResponseBody = components.AgentConversation | components.ModelConversation;
/** @internal */
...
/** @internal */
export type ResponseBody$Outbound = components.AgentConversation$Outbound | components.ModelConversation$Outbound;
/** @internal */
