...
/** @internal */
exports.CompletionArgsStop$inboundSchema = z.union([z.string(), z.array(z.string())]);
/** @internal */
exports.CompletionArgsStop$outboundSchema = z.union([z.string(), z.array(z.string())]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var CompletionArgsStop$;
(function (CompletionArgsStop$) {
    /** @deprecated use `CompletionArgsStop$inboundSchema` instead. */
    CompletionArgsStop$.inboundSchema = exports.CompletionArgsStop$inboundSchema;
    /** @deprecated use `CompletionArgsStop$outboundSchema` instead. */
    CompletionArgsStop$.outboundSchema = exports.CompletionArgsStop$outboundSchema;
...
function completionArgsStopFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.CompletionArgsStop$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CompletionArgsStop' from JSON`);
}
